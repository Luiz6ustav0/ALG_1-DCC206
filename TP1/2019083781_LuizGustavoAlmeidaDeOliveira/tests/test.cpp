...
//    {{0, Clinic(0, 4, 5, 2)}, {1, Clinic(1, 4, 0, 1)}, {2, Clinic(2, 4, 0, 5)}, {3, Clinic(3, 4, 5, 0)}});
//
///* *****************************
...
//}
//
//TEST_CASE("Patient should know if he has proposed to all") {
//    // given
//    int id = 0, age = 12, posX = 0, posY = 0;
//    Patient p(id, age, posX, posY, clinicsData);
//
//    // when
//    for (int i = 0; i < clinicsData.size(); ++i)
//        p.getNextClinicId();
//
//    // then
//    CHECK_EQ(true, p.proposedToAllClinics());
